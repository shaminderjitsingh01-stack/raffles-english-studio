    ...
    <section className="relative py-28 bg-green-primary overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="reveal">
          ...
          <p className="text-cream/50 text-lg leading-relaxed mb-12 font-light">
        ...
        <div className="reveal">
          {submitted ? (
            <div className="bg-cream/10 backdrop-blur-sm border border-gold/20 rounded-sm p-10">
              ...
              <p className="text-cream font-serif text-2xl font-semibold tracking-tight">Welcome aboard!</p>
              <p className="text-cream/40 text-base mt-2 font-light">Check your inbox for a confirmation email.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-5 py-4 rounded-sm bg-cream/[0.08] border border-cream/15 text-cream placeholder-cream/30 focus:outline-none focus:border-gold/30 focus:ring-1 focus:ring-gold/20 transition-all text-base font-light"
              />
              <button
                type="submit"
                className="bg-gold hover:bg-gold-light text-green-darker font-medium px-8 py-4 rounded-sm transition-all duration-300 hover:shadow-[0_0_30px_rgba(196,169,98,0.2)] text-base tracking-wide whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
          )}
          <p className="text-cream/20 text-xs mt-6 font-light tracking-wide">No spam, ever. Unsubscribe anytime.</p>
        </div>
      </div>
    </section>
  );
