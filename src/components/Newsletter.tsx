        ...
        <div className="reveal">
          {submitted ? (
            <div className="bg-cream/10 backdrop-blur-sm border border-gold/20 rounded-sm p-10">
              ...
              <p className="text-cream font-serif text-xl font-semibold tracking-tight">Welcome aboard!</p>
              <p className="text-cream/40 text-sm mt-2 font-light">Check your inbox for a confirmation email.</p>
            </div>
          ) : (
          ...
          <p className="text-cream/20 text-[11px] mt-6 font-light tracking-wide">No spam, ever. Unsubscribe anytime.</p>
        </div>
      </div>
    </section>
  );
